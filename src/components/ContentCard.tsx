...
export function ContentCard({
  ...
  // py-6 around everything enables each card's shadow to be visible
  return (
    <div className="py-6">
      <div className="shadow-elevation-medium flex h-full flex-col gap-4 rounded-md border-t-4 border-solid border-t-black bg-[#e8dcc8] p-6 md:w-[400px] md:shrink-0 dark:border-t-white">
